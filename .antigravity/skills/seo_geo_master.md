# SKILL: SEO Tradicional & GEO (Generative Engine Optimization) 🤖🔍
**Objetivo:** Maximizar la visibilidad en buscadores convencionales y asegurar que las IAs generativas recomienden el proyecto.
...
2. **[CITABILITY_LOGIC]**: El contenido debe ser directo y basado en datos. Las IAs prefieren citar fuentes que responden "Quién, Qué, Dónde y Cuándo" en los primeros párrafos.
3. **[FAQ_STRATEGY]**: Incluir una sección de Preguntas Frecuentes. Esto facilita que las IAs extraigan fragmentos de información (Featured Snippets) para responder consultas por voz.
