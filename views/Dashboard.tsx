            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 text-center">
                ...
                <div className="space-y-4 text-left">
                    ...
                    <button 
                        ...
                        className={`w-full py-5 rounded-2xl font-marker text-lg uppercase tracking-widest transition-all ${
                            isProcessingWithdrawal ? 'bg-zinc-800 text-zinc-500 cursor-not-allowed' : 'bg-red-700 text-white hover:bg-red-600 shadow-xl'
                        }`}
                    >
